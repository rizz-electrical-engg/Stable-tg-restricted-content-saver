...
BOT_TOKEN = getenv("BOT_TOKEN", "7306696666:AAHwvcJ8RcIljswKIropp4H2iEHUkvV3lTU")
...
LOG_GROUP = getenv("LOG_GROUP", "2164681451")
CHANNEL_ID = int(getenv("CHANNEL_ID", "rixxwillfix"))
